...
<html>
	...
	<body>
		...
		<div id="edit-defect" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<fieldset class="buttons">
					...
					<g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" formnovalidate="" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" style="float:right;" />
				</fieldset>
			</g:form>
		</div>
	</body>
